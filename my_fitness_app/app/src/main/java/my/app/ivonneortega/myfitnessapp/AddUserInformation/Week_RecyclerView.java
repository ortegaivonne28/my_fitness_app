...
public class Week_RecyclerView extends RecyclerView.Adapter<Week_RecyclerView.CustomViewHolder> {
        ...
        switch (viewType)
        {
            case VIEW_TYPE_ADD:
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(my.app.ivonneortega.myfitnessapp.R.layout.add_week_routine, parent, false);
                return new CustomViewHolder(view);

            case VIEW_TYPE_WEEK:
                View view1 = LayoutInflater.from(parent.getContext())
                        .inflate(my.app.ivonneortega.myfitnessapp.R.layout.week_routine, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder{
        ...
        public CustomViewHolder(View itemView) {
            super(itemView);
            mAddWeek = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.week_add_title);
            mWeekTitle = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.week_routine_number);
            mAddRoot = itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.root_add_week);
            mWeekRoot = itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.week_root);
