...
public class ChallengesRecyclerViewAdapter extends RecyclerView.Adapter<ChallengesRecyclerViewAdapter.ChallengesViewHolder> {
    ...
    public ChallengesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(my.app.ivonneortega.myfitnessapp.R.layout.custom_challenges, parent, false);
    ...
    public class ChallengesViewHolder extends RecyclerView.ViewHolder{
        ...
        public ChallengesViewHolder(View itemView) {
            super(itemView);
            mChallengeName = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.challenge_name);
            mChallengeCreator = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.challenge_created);
            mChallengeStatus = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.challenge_status);
            mRoot = itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.root);
        }
    }
