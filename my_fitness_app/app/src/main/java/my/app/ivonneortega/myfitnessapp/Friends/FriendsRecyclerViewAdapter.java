...
public class FriendsRecyclerViewAdapter extends RecyclerView.Adapter {
        ...
        switch (viewType)
        {
            case VIEW_TYPE_FRIEND:
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(my.app.ivonneortega.myfitnessapp.R.layout.custom_friends, parent, false);
    ...
    public class FriendsViewHolder extends RecyclerView.ViewHolder{
        ...
        public FriendsViewHolder(View itemView) {
            super(itemView);
            mFriendName = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.friend_name);
    ...
    public class WorkoutsViewHolder extends RecyclerView.ViewHolder{
        ...
        public WorkoutsViewHolder(View itemView) {
            super(itemView);
            mWorkoutName = (TextView) itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.friend_name);
            mRoot = itemView.findViewById(my.app.ivonneortega.myfitnessapp.R.id.root);
        }
    }
