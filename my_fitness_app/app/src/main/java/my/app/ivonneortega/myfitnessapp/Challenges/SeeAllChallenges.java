...
public class SeeAllChallenges extends Fragment implements ChallengesRecyclerViewAdapter.ChallengesRecyclerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(my.app.ivonneortega.myfitnessapp.R.layout.fragment_see_all_challenges, container, false);
    }
...
//    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPendingRecyclerView = (RecyclerView) view.findViewById(my.app.ivonneortega.myfitnessapp.R.id.recycler_view);
        ...
        mAcceptedRecyclerView = (RecyclerView) view.findViewById(my.app.ivonneortega.myfitnessapp.R.id.recycler_view2);
